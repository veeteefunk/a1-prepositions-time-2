...
form.addEventListener('submit', function(e) {
    ...
    ex1 == "on" ? iconAnswer1.classList.add("fa-circle-check") : iconAnswer1.classList.add("fa-circle-xmark");
    ...
    ex10 == "at" ? iconAnswer10.classList.add("fa-circle-check") : iconAnswer10.classList.add("fa-circle-xmark");
});
